...
const projects = [
    {
        ...
        tags: ['NextJs', 'API Integration', 'Tailwind CSS', 'Shadcn/UI', 'Express Js', 'Mongodb'],
    ...
    },
    {
        ...
        tags: ['Next.js', 'Redux', 'Typescript', 'Tailwind CSS', 'Shadcn/UI', 'Node.js', 'MongoDB', 'Stripe'],
        ...
        >
            ...
            <div className="flex flex-col flex-1 p-5 gap-3">
                ...
                <div className="flex items-start justify-between gap-2">
                    <h3 className="text-[17px] font-semibold text-zinc-900 dark:text-zinc-100 leading-snug group-hover:text-[var(--accent)] transition-colors duration-300" style={{ '--accent': project.accent } as any}>
                        {project.title}
                    </h3>
